...
Route::group(['middleware' => 'admin'], function () {
    ...
    Route::post('admin/homework/homework/add', [HomeworkController::class, 'homework_insert']);

    Route::get('admin/homework/homework/edit/{id}', [HomeworkController::class, 'homework_edit']);
    Route::post('admin/homework/homework/edit/{id}', [HomeworkController::class, 'homework_update']);
    Route::get('admin/homework/homework/delete/{id}', [HomeworkController::class, 'homework_delete']);
    Route::get('admin/homework/homework/submitted/{id}', [HomeworkController::class, 'homework_submitted']);
    ...
    Route::post('admin/fees_collection/collect_fees/add_fees/{student_id}', [FeesCollectionController::class, 'add_fees_insert']);
...
Route::group(['middleware' => 'student'], function () {
    ...
    Route::get('student/fees_collection', [FeesCollectionController::class, 'collect_fees_student']);
    Route::post('student/fees_collection', [FeesCollectionController::class, 'collect_fees_student_payment']);
...
Route::group(['middleware' => 'parent'], function () {
    ...
    Route::get('parent/my_student/submitted_homework/{id}', [HomeworkController::class, 
        'submitted_homework_student_parent']);
